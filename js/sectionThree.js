function createDynamicDiplomes()
{
...
const createForm = (index) =>{
  ...
  <table name="education" class="RegistrationFormTable">
								...
								<tr>				
									<td class="error2">
										<strong>Question 1 : Quel type de grade / diplôme / programme est-il?</strong> 
										<select name="TypeOfDegreeTrainingFields1" class="selectboxLong section3 error2" style="width:auto;" required="" aria-required="true">											
									...
									<label id="TypeOfDegreeTrainingFields1-error" class="error" for="TypeOfDegreeTrainingFields1">Ce champ est obligatoire.</label></td>
								</tr>
								<tr>				
									<td class="error2">
										<strong>Question 2 : Combien d'années et/ou de mois sont-ils nécessaires pour compléter ce diplôme?</strong>
											<!--<div style='margin-left:20px;'>-->
												<br>	
												Nombre d'année(s) : 
												<select name="ProgramDurationInYearsTrainingFields1" class="section3 error2" style="width:auto;" required="" aria-required="true">
													<option value="">-- Veuillez sélectionner --</option>
												...
												&nbsp;&nbsp;&nbsp;&nbsp;
												Nombre de mois : 
												<select name="ProgramDurationInMonthsTrainingFields1" class="section3 error2" style="width:auto;" required="" aria-required="true">
													<option value="">-- Veuillez sélectionner --</option>
										...
										<!--</div>	-->
									<label id="ProgramDurationInYearsTrainingFields1-error" class="error" for="ProgramDurationInYearsTrainingFields1">Ce champ est obligatoire.</label><label id="ProgramDurationInMonthsTrainingFields1-error" class="error" for="ProgramDurationInMonthsTrainingFields1">Ce champ est obligatoire.</label></td>
								</tr>				
								<tr>
									<td class="error2">
										<strong>Question 3 : Quel est le domaine d'études indiqué sur votre diplôme ?<br> 
										(example : Diplôme d'Ingénieur en Informatique) </strong><br>					
										<input type="text" name="trainingfields1" id="trainingfields1" class="textbox section3 error2" required="" aria-required="true">					
									<label id="trainingfields1-error" class="error" for="trainingfields1">Ce champ est obligatoire.</label></td>
								</tr>				
								<tr>
									<td class="error2">
										<strong>Question 4 : Depuis combien d'années avez-vous obtenu ce diplôme? </strong>		
										<select name="YearsAgoDiploma1" class="selectboxLong section3 error2" required="" aria-required="true">
									...
									<label id="YearsAgoDiploma1-error" class="error" for="YearsAgoDiploma1">Ce champ est obligatoire.</label></td>
								</tr>				
								<tr>
									<td>
										<strong>Question 5 : <span style="color:red;"><u>Au cours des 10 dernières années,</u></span> avez-vous déjà exercé une profession directement en lien avec ce domaine de formation? <br>
										<select name="YearsProfessionPractisedDiploma1" class="selectboxLong  section3 error2" required="" aria-required="true">
											<option value="">-- Veuillez sélectionner --</option>
									...
									<tr>
										...
										<label id="CountryDiploma1-error" class="error" for="CountryDiploma1">Ce champ est obligatoire.</label></td>
									</tr>
								</tbody></table>
                </tr>
  `
